...
import com.example.fitnessapp.viewmodel.PostViewModel;
...
public class AllPostFragment extends Fragment {
    ...
    public void onStart() {
        ...
        Log.d(TAG, "onStart called - loading posts...");
        viewModel.loadPosts();
    }
    ...
    private void setupRecyclerView() {
        ...
        // Setup adapter click listeners if needed
