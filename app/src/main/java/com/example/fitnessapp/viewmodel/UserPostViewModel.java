...
public class UserPostViewModel extends AndroidViewModel {
    ...
    private static final String TAG = "UserPostViewModel";
    ...
    public UserPostViewModel(@NonNull Application application) {
        ...
        Log.d(TAG, "UserPostViewModel created");
    }
    ...
    /**
     * Load user posts - called initially and on refresh
     */
    ...
    /**
     * Internal method to load user posts
     */
    private void loadPosts(boolean isRefreshing) {
        ...
        // Make API call for user posts
        repository.getUserPosts(params, new Callback<ApiResponse<List<PostResponse>>>() {
            @Override
