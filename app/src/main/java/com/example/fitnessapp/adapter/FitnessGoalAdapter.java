...
public class FitnessGoalAdapter extends CustomSpinnerAdapter<FitnessGoal> {
    private final LayoutInflater layoutInflater;
    private final Context context;

    public FitnessGoalAdapter(Context context, List<FitnessGoal> items) {
        super(context, items);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FitnessGoal item = super.getItem(position);
